...
import { pricingPackages, faqItems, getWhatsAppUrl, FREELANCE_CONFIG } from '../../src/lib/data/freelanceData';
...
describe('freelance copy & data contract', () => {
  ...
  it('generates valid WhatsApp URLs with encoded messages', () => {
    const text = 'Halo Ryan, saya mau order paket Pro!';
