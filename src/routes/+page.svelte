<script lang="ts">
  ...
  const copy = {
    ...
    id: {
      ...
      aboutRows: [
        { kicker: 'Peran sekarang', body: `Mimpin delivery tapi tetap turun tangan di teknis di ${profile.company} — dari rencana, review, sampai ambil keputusan pas di production.` },
        { kicker: 'Pendidikan', body: 'Dasar ilmu komputer yang kuat, jadi pegangan buat ngambil keputusan produk, arsitektur, dan engineering.' },
        { kicker: 'Jangkauan kerja', body: 'Biasa pindah-pindah antar bagian produk dan urusan production pas sistem butuh orang yang beneran pegang.' },
      ],
      workKicker: 'Karya Pilihan',
      workHeading: 'Proyek pilihan yang beneran jalan di production.',
      workIntro: 'Civic-tech, developer tooling, automation, sampai sistem deployment — dibangun buat kebutuhan nyata, bukan sekadar demo.',
      open: 'Buka',
