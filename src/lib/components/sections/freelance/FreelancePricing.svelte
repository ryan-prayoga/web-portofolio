...
<section id="packages" class="mx-auto max-w-5xl px-6 py-16 sm:py-24 border-t border-rule">
      ...
      >
        <div>
          {#if pkg.popular}
            <div class="mb-4">
              <span
                class="bg-accent text-paper inline-flex items-center gap-1.5 px-2.5 py-1 font-display text-xs font-bold tracking-wide uppercase"
              >
          ...
          <span class="font-display text-xs sm:text-sm uppercase tracking-wide text-muted block font-medium">
            {pkg.tag[locale]}
          </span>
          ...
          <p class="mt-1 font-display text-xs text-muted uppercase tracking-wide font-medium">
          ...
          <div
            class="mt-4 pt-4 border-t border-rule font-display text-xs sm:text-sm text-muted flex items-center justify-between"
          >
          ...
          <div class="mt-6">
            <span class="font-display text-xs sm:text-sm font-semibold uppercase tracking-wide text-ink block mb-3">
        ...
        <div class="mt-8 pt-6 border-t border-rule">
          <a
            ...
            class="flex w-full items-center justify-center gap-2 py-3 font-display text-base tracking-wide uppercase transition-all {pkg.popular
  ...
  <div class="mt-10 p-6 bg-paper/60 border border-dashed border-rule rounded-none text-center max-w-2xl mx-auto">
    <p class="text-muted flex items-center justify-center gap-2 font-display text-xs sm:text-sm">
