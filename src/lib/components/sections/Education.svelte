...
<section id="education" class="mx-auto max-w-5xl px-6 py-14" aria-labelledby="education-heading">
  ...
  <div class="mt-8 grid gap-4 sm:grid-cols-2">
    {#each entries as entry (entry.school)}
      ...
      >
        <span class="text-accent font-mono text-xs font-semibold uppercase">{entry.note}</span>
    ...
    <div
      ...
      use:drawCard={{ resketchOnHover: true }}
    >
      <p class="text-accent font-mono text-xs font-semibold tracking-wider uppercase">{t.education.languages}</p>
