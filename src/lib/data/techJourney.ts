...
export const techJourney: TechStep[] = [
  ...
  },
  {
    ...
    description: 'Masuk ke dunia frontend modern dengan Vue ecosystem. Membangun UI interaktif dan SSR application.',
    category: 'frontend',
    color: 'blue',
  },
  {
    ...
    description: 'Migrasi dan pengembangan dengan Composition API, TypeScript, dan arsitektur yang lebih modern.',
    category: 'frontend',
    color: 'blue',
  },
  {
    ...
    description: 'Eksplorasi ke backend high-performance. Memahami concurrency, microservices, dan efisiensi sistem.',
    category: 'backend',
    color: 'cyan',
  },
  {
    ...
    description: 'Mengadopsi pendekatan kompilasi terbaru untuk UI yang lebih ringan, reaktif, dan performant.',
    category: 'frontend',
    color: 'violet',
  },
  {
